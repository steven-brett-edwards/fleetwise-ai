...
export function createMockMaintenanceRecord(overrides?: Partial<MaintenanceRecord>): MaintenanceRecord {
  return {
    id: 1,
    vehicleId: 1,
    workOrderId: 1,
...
export function createMockMaintenanceSchedule(overrides?: Partial<MaintenanceSchedule>): MaintenanceSchedule {
  return {
    id: 1,
    vehicleId: 1,
