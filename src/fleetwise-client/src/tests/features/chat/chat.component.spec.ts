...
describe('ChatComponent', () => {
  ...
  beforeEach(() => {
    ...
    mockChatService = {
      ...
      streamMessage: jasmine.createSpy('streamMessage').and.returnValue(streamSubject.asObservable()),
    ...
    component.messageList = { nativeElement: { scrollTop: 0, scrollHeight: 500 } } as ElementRef<HTMLDivElement>;
  });
