...
describe('VehicleListComponent', () => {
  ...
  it('loadVehicles_WhenServiceReturns_SetsVehiclesAndLoading', () => {
    ...
    mockVehicleService.getAll.and.returnValue(of([expectedActiveVehicle, expectedInShopVehicle]));
  ...
  it('extractFilterOptions_WhenNoStatusFilter_ExtractsSortedStatusOptions', () => {
    // Setup
    component.statusFilter = '';
    const vehicleWithActiveStatus = createMockVehicle({ status: 'Active', department: 'Ops', fuelType: 'Gas' });
    const vehicleWithInShopStatus = createMockVehicle({ status: 'InShop', department: 'Ops', fuelType: 'Gas' });
    mockVehicleService.getAll.and.returnValue(of([vehicleWithInShopStatus, vehicleWithActiveStatus]));
  ...
  it('extractFilterOptions_WhenCalled_ExtractsSortedDepartmentOptions', () => {
    ...
    mockVehicleService.getAll.and.returnValue(of([vehicleInMaintenance, vehicleInAdmin, vehicleInMaintenanceDuplicate]));
  ...
  it('extractFilterOptions_WhenCalled_ExtractsSortedFuelTypeOptions', () => {
    ...
    mockVehicleService.getAll.and.returnValue(of([dieselVehicle, electricVehicle, anotherDieselVehicle]));
