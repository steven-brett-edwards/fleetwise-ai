...
describe('ChatService', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            providers: [ChatService, { provide: ApiService, useValue: mockApiService }],
        });
    ...
    it('sendMessage_WithRequest_DelegatesToApiPost', () => {
        ...
        mockApiService.post.and.returnValue(
            of({ response: 'Hi', conversationId: 'test-id', functionsUsed: [] })
        );
    ...
    it('sendMessage_WhenCalled_ReturnsChatResponse', () => {
        ...
        mockApiService.post.and.returnValue(
            of({ response: expectedResponseText, conversationId: 'id', functionsUsed: [] })
        );
    ...
    it('streamMessage_WhenDataLinesReceived_EmitsEachChunk', (done: DoneFn) => {
        ...
        globalThis.fetch = jasmine
            ...
            .and.returnValue(
                Promise.resolve(
                    createMockSSEResponse(['data: hello\n\ndata: world\n\ndata: [DONE]\n\n'])
                )
            );
    ...
    it('streamMessage_WhenStreamEndsNaturally_CompletesObservable', (done: DoneFn) => {
        ...
        globalThis.fetch = jasmine
            .createSpy('fetch')
            .and.returnValue(Promise.resolve(createMockSSEResponse(['data: chunk\n\n'])));
    ...
    it('streamMessage_WhenNoResponseBody_EmitsError', (done: DoneFn) => {
        ...
        globalThis.fetch = jasmine
            .createSpy('fetch')
            .and.returnValue(Promise.resolve(responseWithNoBody));
    ...
    it('streamMessage_WhenFetchFails_EmitsError', (done: DoneFn) => {
        ...
        globalThis.fetch = jasmine
            .createSpy('fetch')
            .and.returnValue(Promise.reject(expectedNetworkError));
    ...
    it('streamMessage_WhenUnsubscribed_AbortsFetch', () => {
        ...
        globalThis.fetch = jasmine
            .createSpy('fetch')
            .and.callFake((_url: string, init: RequestInit) => {
